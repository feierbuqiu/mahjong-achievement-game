...
namespace Mahjong.AnchorDAG.N09823

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 29 | 30 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 28 | 31 | 32 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 31 | 32 | 33 => 0
  | 17 => 25
  | 25 | 26 | 27 | 29 | 30 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 31 | 32 | 33 => true
  | 17 | 25 | 26 | 27 | 29 | 30 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02137.state
  | 26 => AnchorDAG.N02102.state
  | 27 => AnchorDAG.N02087.state
  | 29 => AnchorDAG.N02078.state
  | 30 => AnchorDAG.N02077.state
...
end Mahjong.AnchorDAG.N09823

#print axioms Mahjong.AnchorDAG.N09823.original_second_player_wins

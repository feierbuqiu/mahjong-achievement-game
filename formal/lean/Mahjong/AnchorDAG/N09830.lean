...
import Mahjong.AnchorDAG.N02080
import Mahjong.AnchorDAG.N02094
import Mahjong.AnchorDAG.N02109
import Mahjong.AnchorDAG.N02144

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N09830

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 28 | 29 | 30 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 29 | 30 | 33 => 0
  | 17 => 25
  | 25 | 26 | 27 | 31 | 32 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 29 | 30 | 33 => true
  | 17 | 25 | 26 | 27 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02144.state
  | 26 => AnchorDAG.N02109.state
  | 27 => AnchorDAG.N02094.state
  | 31 => AnchorDAG.N02080.state
  | 32 => AnchorDAG.N02079.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02144.proved
  · exact AnchorDAG.N02109.proved
  · exact AnchorDAG.N02094.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02080.proved
...
end Mahjong.AnchorDAG.N09830

#print axioms Mahjong.AnchorDAG.N09830.original_second_player_wins

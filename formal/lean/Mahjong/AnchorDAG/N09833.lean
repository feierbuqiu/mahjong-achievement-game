...
import Mahjong.AnchorDAG.N02083
...
namespace Mahjong.AnchorDAG.N09833

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 27 | 31 | 32 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 | 32 | 33 => 0
  | 17 => 25
  | 25 | 26 | 28 | 29 | 30 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 | 32 | 33 => true
  | 17 | 25 | 26 | 28 | 29 | 30 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02147.state
  | 26 => AnchorDAG.N02112.state
  | 28 => AnchorDAG.N02087.state
  | 29 => AnchorDAG.N02083.state
  | 30 => AnchorDAG.N02082.state
...
end Mahjong.AnchorDAG.N09833

#print axioms Mahjong.AnchorDAG.N09833.original_second_player_wins

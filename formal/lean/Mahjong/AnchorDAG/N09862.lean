...
import Mahjong.AnchorDAG.N02100
import Mahjong.AnchorDAG.N02101
import Mahjong.AnchorDAG.N02111
...
namespace Mahjong.AnchorDAG.N09862

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 27 | 28 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 29 | 30 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 | 30 | 31 => 0
  | 17 => 25
  | 25 | 27 | 28 | 32 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 | 30 | 31 => true
  | 17 | 25 | 27 | 28 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02176.state
  | 27 => AnchorDAG.N02121.state
  | 28 => AnchorDAG.N02111.state
  | 32 => AnchorDAG.N02101.state
  | 33 => AnchorDAG.N02100.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N02111.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02101.proved
  · exact AnchorDAG.N02100.proved
...
end Mahjong.AnchorDAG.N09862

#print axioms Mahjong.AnchorDAG.N09862.original_second_player_wins

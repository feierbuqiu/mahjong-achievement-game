...
namespace Mahjong.AnchorDAG.N09865

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 27 | 29 | 30 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 28 | 31 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 31 | 32 => 0
  | 17 => 25
  | 25 | 27 | 29 | 30 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 31 | 32 => true
  | 17 | 25 | 27 | 29 | 30 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02179.state
  | 27 => AnchorDAG.N02124.state
  | 29 => AnchorDAG.N02108.state
  | 30 => AnchorDAG.N02105.state
  | 33 => AnchorDAG.N02102.state
...
end Mahjong.AnchorDAG.N09865

#print axioms Mahjong.AnchorDAG.N09865.original_second_player_wins

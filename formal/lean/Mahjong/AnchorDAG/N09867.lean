...
import Mahjong.AnchorDAG.N02103
import Mahjong.AnchorDAG.N02105
import Mahjong.AnchorDAG.N02110
import Mahjong.AnchorDAG.N02126
import Mahjong.AnchorDAG.N02181

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N09867

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 27 | 29 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 28 | 30 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 30 | 32 => 0
  | 17 => 25
  | 25 | 27 | 29 | 31 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 30 | 32 => true
  | 17 | 25 | 27 | 29 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02181.state
  | 27 => AnchorDAG.N02126.state
  | 29 => AnchorDAG.N02110.state
  | 31 => AnchorDAG.N02105.state
  | 33 => AnchorDAG.N02103.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02110.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02105.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02103.proved
...
end Mahjong.AnchorDAG.N09867

#print axioms Mahjong.AnchorDAG.N09867.original_second_player_wins

...
import Mahjong.AnchorDAG.N02119
import Mahjong.AnchorDAG.N02125
import Mahjong.AnchorDAG.N02190

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N09876

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 28 | 29 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 27 | 30 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 30 | 33 => 0
  | 17 => 25
  | 25 | 28 | 29 | 31 | 32 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 30 | 33 => true
  | 17 | 25 | 28 | 29 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02190.state
  | 28 => AnchorDAG.N02125.state
  | 29 => AnchorDAG.N02119.state
  | 31 => AnchorDAG.N02114.state
  | 32 => AnchorDAG.N02113.state
...
end Mahjong.AnchorDAG.N09876

#print axioms Mahjong.AnchorDAG.N09876.original_second_player_wins

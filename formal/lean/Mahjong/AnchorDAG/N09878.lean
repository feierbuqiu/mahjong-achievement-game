...
import Mahjong.AnchorDAG.N02114
import Mahjong.AnchorDAG.N02115
import Mahjong.AnchorDAG.N02121
import Mahjong.AnchorDAG.N02127
import Mahjong.AnchorDAG.N02192

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N09878

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 28 | 29 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 27 | 30 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 30 | 31 => 0
  | 17 => 25
  | 25 | 28 | 29 | 32 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 30 | 31 => true
  | 17 | 25 | 28 | 29 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02192.state
  | 28 => AnchorDAG.N02127.state
  | 29 => AnchorDAG.N02121.state
  | 32 => AnchorDAG.N02115.state
  | 33 => AnchorDAG.N02114.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02127.proved
  · exact AnchorDAG.N02121.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02115.proved
  · exact AnchorDAG.N02114.proved
...
end Mahjong.AnchorDAG.N09878

#print axioms Mahjong.AnchorDAG.N09878.original_second_player_wins

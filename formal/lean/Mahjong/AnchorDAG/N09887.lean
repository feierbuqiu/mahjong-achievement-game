...
import Mahjong.AnchorDAG.N02128
import Mahjong.AnchorDAG.N02129
import Mahjong.AnchorDAG.N02130
...
namespace Mahjong.AnchorDAG.N09887

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 26 | 27 | 28 | 29 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 28 | 29 => 0
  | 17 => 25
  | 25 | 30 | 31 | 32 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 28 | 29 => true
  | 17 | 25 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N02201.state
  | 30 => AnchorDAG.N02131.state
  | 31 => AnchorDAG.N02130.state
  | 32 => AnchorDAG.N02129.state
  | 33 => AnchorDAG.N02128.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N02130.proved
  · exact AnchorDAG.N02129.proved
  · exact AnchorDAG.N02128.proved
...
end Mahjong.AnchorDAG.N09887

#print axioms Mahjong.AnchorDAG.N09887.original_second_player_wins

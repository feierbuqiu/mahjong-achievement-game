...
import Mahjong.AnchorDAG.N02159
...
namespace Mahjong.AnchorDAG.N09919

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 26 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 25 | 27 | 28 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 28 | 32 => 0
  | 17 => 26
  | 26 | 29 | 30 | 31 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 28 | 32 => true
  | 17 | 26 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 26 => AnchorDAG.N02198.state
  | 29 => AnchorDAG.N02164.state
  | 30 => AnchorDAG.N02161.state
  | 31 => AnchorDAG.N02159.state
  | 33 => AnchorDAG.N02157.state
...
end Mahjong.AnchorDAG.N09919

#print axioms Mahjong.AnchorDAG.N09919.original_second_player_wins

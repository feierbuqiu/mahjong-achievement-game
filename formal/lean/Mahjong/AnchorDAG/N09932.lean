...
import Mahjong.AnchorDAG.N02174
import Mahjong.AnchorDAG.N02175
import Mahjong.AnchorDAG.N02176
import Mahjong.AnchorDAG.N02186
import Mahjong.AnchorDAG.N02196

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N09932

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 27 | 28 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 25 | 26 | 29 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 | 29 | 30 => 0
  | 17 => 27
  | 27 | 28 | 31 | 32 | 33 => 17
  | _ => 0
...
def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 | 29 | 30 => true
  | 17 | 27 | 28 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 27 => AnchorDAG.N02196.state
  | 28 => AnchorDAG.N02186.state
  | 31 => AnchorDAG.N02176.state
  | 32 => AnchorDAG.N02175.state
  | 33 => AnchorDAG.N02174.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02196.proved
  · exact AnchorDAG.N02186.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N02176.proved
  · exact AnchorDAG.N02175.proved
  · exact AnchorDAG.N02174.proved
...
end Mahjong.AnchorDAG.N09932

#print axioms Mahjong.AnchorDAG.N09932.original_second_player_wins

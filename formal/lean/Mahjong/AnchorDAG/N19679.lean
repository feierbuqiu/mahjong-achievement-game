...
import Mahjong.AnchorDAG.N09819
import Mahjong.AnchorDAG.N09823
import Mahjong.AnchorDAG.N09833
import Mahjong.AnchorDAG.N09853
import Mahjong.AnchorDAG.N09888
import Mahjong.AnchorDAG.N09965

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19679

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 30 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 31 | 32 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 | 32 | 33 => 0
  | 16 => 17
  | 17 | 25 | 26 | 27 | 28 | 29 | 30 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 | 32 | 33 => true
  | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09965.state
  | 25 => AnchorDAG.N09888.state
  | 26 => AnchorDAG.N09853.state
  | 27 => AnchorDAG.N09833.state
  | 28 => AnchorDAG.N09823.state
  | 29 => AnchorDAG.N09819.state
  | 30 => AnchorDAG.N09818.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09888.proved
  · exact AnchorDAG.N09853.proved
  · exact AnchorDAG.N09833.proved
  · exact AnchorDAG.N09823.proved
  · exact AnchorDAG.N09819.proved
...
end Mahjong.AnchorDAG.N19679

#print axioms Mahjong.AnchorDAG.N19679.original_second_player_wins

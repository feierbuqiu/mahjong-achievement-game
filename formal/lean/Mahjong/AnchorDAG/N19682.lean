...
import Mahjong.AnchorDAG.N09818
import Mahjong.AnchorDAG.N09822
import Mahjong.AnchorDAG.N09826
import Mahjong.AnchorDAG.N09836
import Mahjong.AnchorDAG.N09856
import Mahjong.AnchorDAG.N09891
import Mahjong.AnchorDAG.N09968

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19682

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 30 | 31 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 31 | 32 => 0
  | 16 => 17
  | 17 | 25 | 26 | 27 | 28 | 29 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 31 | 32 => true
  | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09968.state
  | 25 => AnchorDAG.N09891.state
  | 26 => AnchorDAG.N09856.state
  | 27 => AnchorDAG.N09836.state
  | 28 => AnchorDAG.N09826.state
  | 29 => AnchorDAG.N09822.state
  | 33 => AnchorDAG.N09818.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09891.proved
  · exact AnchorDAG.N09856.proved
  · exact AnchorDAG.N09836.proved
  · exact AnchorDAG.N09826.proved
  · exact AnchorDAG.N09822.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09818.proved
...
end Mahjong.AnchorDAG.N19682

#print axioms Mahjong.AnchorDAG.N19682.original_second_player_wins

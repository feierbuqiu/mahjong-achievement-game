...
import Mahjong.AnchorDAG.N09829
import Mahjong.AnchorDAG.N09839
import Mahjong.AnchorDAG.N09859
import Mahjong.AnchorDAG.N09894
import Mahjong.AnchorDAG.N09971

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19685

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 30 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 29 | 31 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 31 | 32 => 0
  | 16 => 17
  | 17 | 25 | 26 | 27 | 28 | 30 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 31 | 32 => true
  | 16 | 17 | 25 | 26 | 27 | 28 | 30 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09971.state
  | 25 => AnchorDAG.N09894.state
  | 26 => AnchorDAG.N09859.state
  | 27 => AnchorDAG.N09839.state
  | 28 => AnchorDAG.N09829.state
  | 30 => AnchorDAG.N09822.state
  | 33 => AnchorDAG.N09819.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09894.proved
  · exact AnchorDAG.N09859.proved
  · exact AnchorDAG.N09839.proved
  · exact AnchorDAG.N09829.proved
  · exact AnchorDAG.N00000.proved
...
end Mahjong.AnchorDAG.N19685

#print axioms Mahjong.AnchorDAG.N19685.original_second_player_wins

...
import Mahjong.AnchorDAG.N09824
import Mahjong.AnchorDAG.N09826
import Mahjong.AnchorDAG.N09831
import Mahjong.AnchorDAG.N09847
import Mahjong.AnchorDAG.N09867
import Mahjong.AnchorDAG.N09902
import Mahjong.AnchorDAG.N09979

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19693

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 29 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 28 | 30 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 | 32 => 0
  | 16 => 17
  | 17 | 25 | 26 | 27 | 29 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 | 32 => true
  | 16 | 17 | 25 | 26 | 27 | 29 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09979.state
  | 25 => AnchorDAG.N09902.state
  | 26 => AnchorDAG.N09867.state
  | 27 => AnchorDAG.N09847.state
  | 29 => AnchorDAG.N09831.state
  | 31 => AnchorDAG.N09826.state
  | 33 => AnchorDAG.N09824.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09902.proved
  · exact AnchorDAG.N09867.proved
  · exact AnchorDAG.N09847.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09831.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09826.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09824.proved
...
end Mahjong.AnchorDAG.N19693

#print axioms Mahjong.AnchorDAG.N19693.original_second_player_wins

...
import Mahjong.AnchorDAG.N09833
import Mahjong.AnchorDAG.N09834
import Mahjong.AnchorDAG.N09837
import Mahjong.AnchorDAG.N09843
import Mahjong.AnchorDAG.N09873
import Mahjong.AnchorDAG.N09908
import Mahjong.AnchorDAG.N09985

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19699

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 32 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 | 33 => 0
  | 16 => 17
  | 17 | 25 | 26 | 28 | 29 | 30 | 31 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 | 33 => true
  | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 31 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09985.state
  | 25 => AnchorDAG.N09908.state
  | 26 => AnchorDAG.N09873.state
  | 28 => AnchorDAG.N09843.state
  | 29 => AnchorDAG.N09837.state
  | 30 => AnchorDAG.N09834.state
  | 31 => AnchorDAG.N09833.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09908.proved
  · exact AnchorDAG.N09873.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09843.proved
  · exact AnchorDAG.N09837.proved
  · exact AnchorDAG.N09834.proved
  · exact AnchorDAG.N09833.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
...
end Mahjong.AnchorDAG.N19699

#print axioms Mahjong.AnchorDAG.N19699.original_second_player_wins

...
import Mahjong.AnchorDAG.N09839
import Mahjong.AnchorDAG.N09845
import Mahjong.AnchorDAG.N09875
import Mahjong.AnchorDAG.N09910
import Mahjong.AnchorDAG.N09987

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19701

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 31 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 | 32 => 0
  | 16 => 17
  | 17 | 25 | 26 | 28 | 29 | 30 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 | 32 => true
  | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09987.state
  | 25 => AnchorDAG.N09910.state
  | 26 => AnchorDAG.N09875.state
  | 28 => AnchorDAG.N09845.state
  | 29 => AnchorDAG.N09839.state
  | 30 => AnchorDAG.N09836.state
  | 33 => AnchorDAG.N09833.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09910.proved
  · exact AnchorDAG.N09875.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09845.proved
  · exact AnchorDAG.N09839.proved
...
end Mahjong.AnchorDAG.N19701

#print axioms Mahjong.AnchorDAG.N19701.original_second_player_wins

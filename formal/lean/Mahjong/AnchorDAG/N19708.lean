...
import Mahjong.AnchorDAG.N09840
import Mahjong.AnchorDAG.N09841
import Mahjong.AnchorDAG.N09842
import Mahjong.AnchorDAG.N09852
import Mahjong.AnchorDAG.N09882
import Mahjong.AnchorDAG.N09917
import Mahjong.AnchorDAG.N09994

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19708

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 29 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 29 | 30 => 0
  | 16 => 17
  | 17 | 25 | 26 | 28 | 31 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 29 | 30 => true
  | 16 | 17 | 25 | 26 | 28 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09994.state
  | 25 => AnchorDAG.N09917.state
  | 26 => AnchorDAG.N09882.state
  | 28 => AnchorDAG.N09852.state
  | 31 => AnchorDAG.N09842.state
  | 32 => AnchorDAG.N09841.state
  | 33 => AnchorDAG.N09840.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09917.proved
  · exact AnchorDAG.N09882.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09852.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09842.proved
  · exact AnchorDAG.N09841.proved
  · exact AnchorDAG.N09840.proved
...
end Mahjong.AnchorDAG.N19708

#print axioms Mahjong.AnchorDAG.N19708.original_second_player_wins

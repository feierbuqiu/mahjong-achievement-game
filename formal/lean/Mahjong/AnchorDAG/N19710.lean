...
import Mahjong.AnchorDAG.N09845
import Mahjong.AnchorDAG.N09847
import Mahjong.AnchorDAG.N09850
import Mahjong.AnchorDAG.N09884
import Mahjong.AnchorDAG.N09919
import Mahjong.AnchorDAG.N09996

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19710

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 28 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 32 => 0
  | 16 => 17
  | 17 | 25 | 26 | 29 | 30 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 32 => true
  | 16 | 17 | 25 | 26 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09996.state
  | 25 => AnchorDAG.N09919.state
  | 26 => AnchorDAG.N09884.state
  | 29 => AnchorDAG.N09850.state
  | 30 => AnchorDAG.N09847.state
  | 31 => AnchorDAG.N09845.state
  | 33 => AnchorDAG.N09843.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09919.proved
  · exact AnchorDAG.N09884.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09850.proved
  · exact AnchorDAG.N09847.proved
  · exact AnchorDAG.N09845.proved
  · exact AnchorDAG.N00000.proved
...
end Mahjong.AnchorDAG.N19710

#print axioms Mahjong.AnchorDAG.N19710.original_second_player_wins

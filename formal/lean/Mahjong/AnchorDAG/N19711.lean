...
namespace Mahjong.AnchorDAG.N19711

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 28 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 31 => 0
  | 16 => 17
  | 17 | 25 | 26 | 29 | 30 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 31 => true
  | 16 | 17 | 25 | 26 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09997.state
  | 25 => AnchorDAG.N09920.state
  | 26 => AnchorDAG.N09885.state
  | 29 => AnchorDAG.N09851.state
  | 30 => AnchorDAG.N09848.state
  | 32 => AnchorDAG.N09845.state
  | 33 => AnchorDAG.N09844.state
...
end Mahjong.AnchorDAG.N19711

#print axioms Mahjong.AnchorDAG.N19711.original_second_player_wins

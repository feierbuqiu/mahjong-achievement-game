...
import Mahjong.AnchorDAG.N09849
import Mahjong.AnchorDAG.N09850
import Mahjong.AnchorDAG.N09851
...
namespace Mahjong.AnchorDAG.N19713

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 28 | 29 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 29 => 0
  | 16 => 17
  | 17 | 25 | 26 | 30 | 31 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 | 29 => true
  | 16 | 17 | 25 | 26 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N09999.state
  | 25 => AnchorDAG.N09922.state
  | 26 => AnchorDAG.N09887.state
  | 30 => AnchorDAG.N09852.state
  | 31 => AnchorDAG.N09851.state
  | 32 => AnchorDAG.N09850.state
  | 33 => AnchorDAG.N09849.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N09851.proved
  · exact AnchorDAG.N09850.proved
  · exact AnchorDAG.N09849.proved
...
end Mahjong.AnchorDAG.N19713

#print axioms Mahjong.AnchorDAG.N19713.original_second_player_wins

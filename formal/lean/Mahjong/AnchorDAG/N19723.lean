...
import Mahjong.AnchorDAG.N09860
import Mahjong.AnchorDAG.N09861
import Mahjong.AnchorDAG.N09862
import Mahjong.AnchorDAG.N09872
...
namespace Mahjong.AnchorDAG.N19723

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 28 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 29 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 | 30 => 0
  | 16 => 17
  | 17 | 25 | 27 | 28 | 31 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 | 30 => true
  | 16 | 17 | 25 | 27 | 28 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10009.state
  | 25 => AnchorDAG.N09932.state
  | 27 => AnchorDAG.N09882.state
  | 28 => AnchorDAG.N09872.state
  | 31 => AnchorDAG.N09862.state
  | 32 => AnchorDAG.N09861.state
  | 33 => AnchorDAG.N09860.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N09872.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09862.proved
  · exact AnchorDAG.N09861.proved
  · exact AnchorDAG.N09860.proved
...
end Mahjong.AnchorDAG.N19723

#print axioms Mahjong.AnchorDAG.N19723.original_second_player_wins

...
namespace Mahjong.AnchorDAG.N19724

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 29 | 30 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 28 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 33 => 0
  | 16 => 17
  | 17 | 25 | 27 | 29 | 30 | 31 | 32 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 | 33 => true
  | 16 | 17 | 25 | 27 | 29 | 30 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10010.state
  | 25 => AnchorDAG.N09933.state
  | 27 => AnchorDAG.N09883.state
  | 29 => AnchorDAG.N09869.state
  | 30 => AnchorDAG.N09866.state
  | 31 => AnchorDAG.N09864.state
  | 32 => AnchorDAG.N09863.state
...
end Mahjong.AnchorDAG.N19724

#print axioms Mahjong.AnchorDAG.N19724.original_second_player_wins

...
import Mahjong.AnchorDAG.N09885
import Mahjong.AnchorDAG.N09886
import Mahjong.AnchorDAG.N09887
import Mahjong.AnchorDAG.N09943
import Mahjong.AnchorDAG.N10020

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19734

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 27 | 28 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 28 => 0
  | 16 => 17
  | 17 | 25 | 29 | 30 | 31 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 | 28 => true
  | 16 | 17 | 25 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10020.state
  | 25 => AnchorDAG.N09943.state
  | 29 => AnchorDAG.N09887.state
  | 30 => AnchorDAG.N09886.state
  | 31 => AnchorDAG.N09885.state
  | 32 => AnchorDAG.N09884.state
  | 33 => AnchorDAG.N09883.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09887.proved
  · exact AnchorDAG.N09886.proved
  · exact AnchorDAG.N09885.proved
...
end Mahjong.AnchorDAG.N19734

#print axioms Mahjong.AnchorDAG.N19734.original_second_player_wins

...
import Mahjong.AnchorDAG.N09890
import Mahjong.AnchorDAG.N09895
import Mahjong.AnchorDAG.N09901
import Mahjong.AnchorDAG.N09911
import Mahjong.AnchorDAG.N09926
import Mahjong.AnchorDAG.N10024

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19738

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 29 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 30 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 30 | 33 => 0
  | 16 => 17
  | 17 | 26 | 27 | 28 | 29 | 31 | 32 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 30 | 33 => true
  | 16 | 17 | 26 | 27 | 28 | 29 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10024.state
  | 26 => AnchorDAG.N09926.state
  | 27 => AnchorDAG.N09911.state
  | 28 => AnchorDAG.N09901.state
  | 29 => AnchorDAG.N09895.state
  | 31 => AnchorDAG.N09890.state
  | 32 => AnchorDAG.N09889.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09926.proved
  · exact AnchorDAG.N09911.proved
  · exact AnchorDAG.N09901.proved
  · exact AnchorDAG.N09895.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09890.proved
...
end Mahjong.AnchorDAG.N19738

#print axioms Mahjong.AnchorDAG.N19738.original_second_player_wins

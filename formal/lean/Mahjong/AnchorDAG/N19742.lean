...
import Mahjong.AnchorDAG.N09892
...
import Mahjong.AnchorDAG.N09930
import Mahjong.AnchorDAG.N10028

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19742

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 29 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 29 | 32 => 0
  | 16 => 17
  | 17 | 26 | 27 | 28 | 30 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 29 | 32 => true
  | 16 | 17 | 26 | 27 | 28 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10028.state
  | 26 => AnchorDAG.N09930.state
  | 27 => AnchorDAG.N09915.state
  | 28 => AnchorDAG.N09905.state
  | 30 => AnchorDAG.N09896.state
  | 31 => AnchorDAG.N09894.state
  | 33 => AnchorDAG.N09892.state
...
end Mahjong.AnchorDAG.N19742

#print axioms Mahjong.AnchorDAG.N19742.original_second_player_wins

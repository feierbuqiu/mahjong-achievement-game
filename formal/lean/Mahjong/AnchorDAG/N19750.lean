...
import Mahjong.AnchorDAG.N09938
import Mahjong.AnchorDAG.N10036

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19750

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 28 | 29 | 30 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 27 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 33 => 0
  | 16 => 17
  | 17 | 26 | 28 | 29 | 30 | 31 | 32 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 33 => true
  | 16 | 17 | 26 | 28 | 29 | 30 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10036.state
  | 26 => AnchorDAG.N09938.state
  | 28 => AnchorDAG.N09918.state
  | 29 => AnchorDAG.N09914.state
  | 30 => AnchorDAG.N09911.state
  | 31 => AnchorDAG.N09909.state
  | 32 => AnchorDAG.N09908.state
...
end Mahjong.AnchorDAG.N19750

#print axioms Mahjong.AnchorDAG.N19750.original_second_player_wins

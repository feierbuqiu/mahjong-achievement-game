...
import Mahjong.AnchorDAG.N09909
import Mahjong.AnchorDAG.N09910
import Mahjong.AnchorDAG.N09913
import Mahjong.AnchorDAG.N09916
import Mahjong.AnchorDAG.N09920
import Mahjong.AnchorDAG.N09940
import Mahjong.AnchorDAG.N10038

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19752

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 28 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 27 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 31 => 0
  | 16 => 17
  | 17 | 26 | 28 | 29 | 30 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 31 => true
  | 16 | 17 | 26 | 28 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10038.state
  | 26 => AnchorDAG.N09940.state
  | 28 => AnchorDAG.N09920.state
  | 29 => AnchorDAG.N09916.state
  | 30 => AnchorDAG.N09913.state
  | 32 => AnchorDAG.N09910.state
  | 33 => AnchorDAG.N09909.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09940.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09920.proved
  · exact AnchorDAG.N09916.proved
  · exact AnchorDAG.N09913.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09910.proved
  · exact AnchorDAG.N09909.proved
...
end Mahjong.AnchorDAG.N19752

#print axioms Mahjong.AnchorDAG.N19752.original_second_player_wins

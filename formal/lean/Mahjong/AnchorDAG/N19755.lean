...
import Mahjong.AnchorDAG.N09918
import Mahjong.AnchorDAG.N09919
import Mahjong.AnchorDAG.N09920
import Mahjong.AnchorDAG.N09921
import Mahjong.AnchorDAG.N09922
import Mahjong.AnchorDAG.N09943
import Mahjong.AnchorDAG.N10041

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19755

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 27 | 28 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 28 => 0
  | 16 => 17
  | 17 | 26 | 29 | 30 | 31 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 | 28 => true
  | 16 | 17 | 26 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10041.state
  | 26 => AnchorDAG.N09943.state
  | 29 => AnchorDAG.N09922.state
  | 30 => AnchorDAG.N09921.state
  | 31 => AnchorDAG.N09920.state
  | 32 => AnchorDAG.N09919.state
  | 33 => AnchorDAG.N09918.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09943.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09922.proved
  · exact AnchorDAG.N09921.proved
  · exact AnchorDAG.N09920.proved
  · exact AnchorDAG.N09919.proved
  · exact AnchorDAG.N09918.proved
...
end Mahjong.AnchorDAG.N19755

#print axioms Mahjong.AnchorDAG.N19755.original_second_player_wins

...
namespace Mahjong.AnchorDAG.N19756

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 27 | 28 | 29 | 30 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 26 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 | 33 => 0
  | 16 => 17
  | 17 | 27 | 28 | 29 | 30 | 31 | 32 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 | 33 => true
  | 16 | 17 | 27 | 28 | 29 | 30 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 17 => AnchorDAG.N10042.state
  | 27 => AnchorDAG.N09938.state
  | 28 => AnchorDAG.N09933.state
  | 29 => AnchorDAG.N09929.state
  | 30 => AnchorDAG.N09926.state
  | 31 => AnchorDAG.N09924.state
  | 32 => AnchorDAG.N09923.state
...
end Mahjong.AnchorDAG.N19756

#print axioms Mahjong.AnchorDAG.N19756.original_second_player_wins

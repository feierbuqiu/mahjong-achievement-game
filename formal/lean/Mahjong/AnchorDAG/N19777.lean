...
import Mahjong.AnchorDAG.N09969
...
import Mahjong.AnchorDAG.N10007
import Mahjong.AnchorDAG.N10028

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19777

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 29 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 32 => 0
  | 16 => 25
  | 25 | 26 | 27 | 28 | 30 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 32 => true
  | 16 | 25 | 26 | 27 | 28 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 25 => AnchorDAG.N10028.state
  | 26 => AnchorDAG.N10007.state
  | 27 => AnchorDAG.N09992.state
  | 28 => AnchorDAG.N09982.state
  | 30 => AnchorDAG.N09973.state
  | 31 => AnchorDAG.N09971.state
  | 33 => AnchorDAG.N09969.state
...
end Mahjong.AnchorDAG.N19777

#print axioms Mahjong.AnchorDAG.N19777.original_second_player_wins

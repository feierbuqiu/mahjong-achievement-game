...
namespace Mahjong.AnchorDAG.N19785

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 | 32 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 27 | 33 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 33 => 0
  | 16 => 25
  | 25 | 26 | 28 | 29 | 30 | 31 | 32 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 33 => true
  | 16 | 25 | 26 | 28 | 29 | 30 | 31 | 32 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 25 => AnchorDAG.N10036.state
  | 26 => AnchorDAG.N10015.state
  | 28 => AnchorDAG.N09995.state
  | 29 => AnchorDAG.N09991.state
  | 30 => AnchorDAG.N09988.state
  | 31 => AnchorDAG.N09986.state
  | 32 => AnchorDAG.N09985.state
...
end Mahjong.AnchorDAG.N19785

#print axioms Mahjong.AnchorDAG.N19785.original_second_player_wins

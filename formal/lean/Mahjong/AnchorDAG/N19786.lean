...
import Mahjong.AnchorDAG.N09992
import Mahjong.AnchorDAG.N09996
import Mahjong.AnchorDAG.N10016
import Mahjong.AnchorDAG.N10037

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19786

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 27 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 => 0
  | 16 => 25
  | 25 | 26 | 28 | 29 | 30 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 => true
  | 16 | 25 | 26 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 25 => AnchorDAG.N10037.state
  | 26 => AnchorDAG.N10016.state
  | 28 => AnchorDAG.N09996.state
  | 29 => AnchorDAG.N09992.state
  | 30 => AnchorDAG.N09989.state
  | 31 => AnchorDAG.N09987.state
  | 33 => AnchorDAG.N09985.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N10037.proved
  · exact AnchorDAG.N10016.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09996.proved
  · exact AnchorDAG.N09992.proved
...
end Mahjong.AnchorDAG.N19786

#print axioms Mahjong.AnchorDAG.N19786.original_second_player_wins

...
import Mahjong.AnchorDAG.N09993
import Mahjong.AnchorDAG.N09997
import Mahjong.AnchorDAG.N10017
import Mahjong.AnchorDAG.N10038

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19787

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 27 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 => 0
  | 16 => 25
  | 25 | 26 | 28 | 29 | 30 | 32 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 31 => true
  | 16 | 25 | 26 | 28 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 25 => AnchorDAG.N10038.state
  | 26 => AnchorDAG.N10017.state
  | 28 => AnchorDAG.N09997.state
  | 29 => AnchorDAG.N09993.state
  | 30 => AnchorDAG.N09990.state
  | 32 => AnchorDAG.N09987.state
  | 33 => AnchorDAG.N09986.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N10038.proved
  · exact AnchorDAG.N10017.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09997.proved
  · exact AnchorDAG.N09993.proved
...
end Mahjong.AnchorDAG.N19787

#print axioms Mahjong.AnchorDAG.N19787.original_second_player_wins

...
namespace Mahjong.AnchorDAG.N19792

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 27 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 26 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 32 => 0
  | 16 => 25
  | 25 | 27 | 28 | 29 | 30 | 31 | 33 => 16
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 32 => true
  | 16 | 25 | 27 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 16 | 25 => AnchorDAG.N10043.state
  | 27 => AnchorDAG.N10016.state
  | 28 => AnchorDAG.N10011.state
  | 29 => AnchorDAG.N10007.state
  | 30 => AnchorDAG.N10004.state
  | 31 => AnchorDAG.N10002.state
  | 33 => AnchorDAG.N10000.state
...
end Mahjong.AnchorDAG.N19792

#print axioms Mahjong.AnchorDAG.N19792.original_second_player_wins

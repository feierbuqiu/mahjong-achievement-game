...
import Mahjong.AnchorDAG.N09967
...
import Mahjong.AnchorDAG.N10005
import Mahjong.AnchorDAG.N10026

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19818

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 30 | 31 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 31 => 0
  | 17 => 25
  | 25 | 26 | 27 | 28 | 29 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 31 => true
  | 17 | 25 | 26 | 27 | 28 | 29 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10026.state
  | 26 => AnchorDAG.N10005.state
  | 27 => AnchorDAG.N09990.state
  | 28 => AnchorDAG.N09980.state
  | 29 => AnchorDAG.N09974.state
  | 32 => AnchorDAG.N09968.state
  | 33 => AnchorDAG.N09967.state
...
end Mahjong.AnchorDAG.N19818

#print axioms Mahjong.AnchorDAG.N19818.original_second_player_wins

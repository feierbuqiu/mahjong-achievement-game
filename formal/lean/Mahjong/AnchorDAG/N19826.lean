...
import Mahjong.AnchorDAG.N09978
import Mahjong.AnchorDAG.N09979
import Mahjong.AnchorDAG.N09980
import Mahjong.AnchorDAG.N09984
import Mahjong.AnchorDAG.N09998
import Mahjong.AnchorDAG.N10013
import Mahjong.AnchorDAG.N10034

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19826

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 28 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 => 0
  | 17 => 25
  | 25 | 26 | 27 | 29 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 => true
  | 17 | 25 | 26 | 27 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10034.state
  | 26 => AnchorDAG.N10013.state
  | 27 => AnchorDAG.N09998.state
  | 29 => AnchorDAG.N09984.state
  | 31 => AnchorDAG.N09980.state
  | 32 => AnchorDAG.N09979.state
  | 33 => AnchorDAG.N09978.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N10034.proved
  · exact AnchorDAG.N10013.proved
  · exact AnchorDAG.N09998.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09984.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09980.proved
  · exact AnchorDAG.N09979.proved
  · exact AnchorDAG.N09978.proved
...
end Mahjong.AnchorDAG.N19826

#print axioms Mahjong.AnchorDAG.N19826.original_second_player_wins

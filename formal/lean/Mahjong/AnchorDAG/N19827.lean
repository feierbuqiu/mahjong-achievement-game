...
import Mahjong.AnchorDAG.N10035

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19827

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 28 | 29 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 29 => 0
  | 17 => 25
  | 25 | 26 | 27 | 30 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 29 => true
  | 17 | 25 | 26 | 27 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10035.state
  | 26 => AnchorDAG.N10014.state
  | 27 => AnchorDAG.N09999.state
  | 30 => AnchorDAG.N09984.state
  | 31 => AnchorDAG.N09983.state
  | 32 => AnchorDAG.N09982.state
  | 33 => AnchorDAG.N09981.state
...
end Mahjong.AnchorDAG.N19827

#print axioms Mahjong.AnchorDAG.N19827.original_second_player_wins

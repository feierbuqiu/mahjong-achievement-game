...
import Mahjong.AnchorDAG.N09988
import Mahjong.AnchorDAG.N09989
import Mahjong.AnchorDAG.N09990
import Mahjong.AnchorDAG.N09994
import Mahjong.AnchorDAG.N09998
import Mahjong.AnchorDAG.N10018
import Mahjong.AnchorDAG.N10039

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19831

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 27 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 30 => 0
  | 17 => 25
  | 25 | 26 | 28 | 29 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 30 => true
  | 17 | 25 | 26 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10039.state
  | 26 => AnchorDAG.N10018.state
  | 28 => AnchorDAG.N09998.state
  | 29 => AnchorDAG.N09994.state
  | 31 => AnchorDAG.N09990.state
  | 32 => AnchorDAG.N09989.state
  | 33 => AnchorDAG.N09988.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N10039.proved
  · exact AnchorDAG.N10018.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09998.proved
  · exact AnchorDAG.N09994.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09990.proved
  · exact AnchorDAG.N09989.proved
  · exact AnchorDAG.N09988.proved
...
end Mahjong.AnchorDAG.N19831

#print axioms Mahjong.AnchorDAG.N19831.original_second_player_wins

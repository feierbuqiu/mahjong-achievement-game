...
import Mahjong.AnchorDAG.N09991
import Mahjong.AnchorDAG.N09992
import Mahjong.AnchorDAG.N09993
import Mahjong.AnchorDAG.N09994
import Mahjong.AnchorDAG.N09999
import Mahjong.AnchorDAG.N10019
import Mahjong.AnchorDAG.N10040

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N19832

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 27 | 29 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 29 => 0
  | 17 => 25
  | 25 | 26 | 28 | 30 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 29 => true
  | 17 | 25 | 26 | 28 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10040.state
  | 26 => AnchorDAG.N10019.state
  | 28 => AnchorDAG.N09999.state
  | 30 => AnchorDAG.N09994.state
  | 31 => AnchorDAG.N09993.state
  | 32 => AnchorDAG.N09992.state
  | 33 => AnchorDAG.N09991.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N10040.proved
  · exact AnchorDAG.N10019.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09999.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N09994.proved
  · exact AnchorDAG.N09993.proved
  · exact AnchorDAG.N09992.proved
  · exact AnchorDAG.N09991.proved
...
end Mahjong.AnchorDAG.N19832

#print axioms Mahjong.AnchorDAG.N19832.original_second_player_wins

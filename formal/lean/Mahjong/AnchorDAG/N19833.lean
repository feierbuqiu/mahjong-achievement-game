...
import Mahjong.AnchorDAG.N09995
...
namespace Mahjong.AnchorDAG.N19833

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 27 | 28 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 => 0
  | 17 => 25
  | 25 | 26 | 29 | 30 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 => true
  | 17 | 25 | 26 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 25 => AnchorDAG.N10041.state
  | 26 => AnchorDAG.N10020.state
  | 29 => AnchorDAG.N09999.state
  | 30 => AnchorDAG.N09998.state
  | 31 => AnchorDAG.N09997.state
  | 32 => AnchorDAG.N09996.state
  | 33 => AnchorDAG.N09995.state
...
end Mahjong.AnchorDAG.N19833

#print axioms Mahjong.AnchorDAG.N19833.original_second_player_wins

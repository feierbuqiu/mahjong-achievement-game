...
namespace Mahjong.AnchorDAG.N19842

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 25 | 32 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 32 => 0
  | 17 => 26
  | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 32 => true
  | 17 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 26 => AnchorDAG.N10043.state
  | 27 => AnchorDAG.N10037.state
  | 28 => AnchorDAG.N10032.state
  | 29 => AnchorDAG.N10028.state
  | 30 => AnchorDAG.N10025.state
  | 31 => AnchorDAG.N10023.state
  | 33 => AnchorDAG.N10021.state
...
end Mahjong.AnchorDAG.N19842

#print axioms Mahjong.AnchorDAG.N19842.original_second_player_wins

...
namespace Mahjong.AnchorDAG.N19844

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 25 | 30 => 1
  | 4 | 5 | 7 => 4
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 30 => 0
  | 17 => 26
  | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 17
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 30 => true
  | 17 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 17 | 26 => AnchorDAG.N10045.state
  | 27 => AnchorDAG.N10039.state
  | 28 => AnchorDAG.N10034.state
  | 29 => AnchorDAG.N10030.state
  | 31 => AnchorDAG.N10026.state
  | 32 => AnchorDAG.N10025.state
  | 33 => AnchorDAG.N10024.state
...
end Mahjong.AnchorDAG.N19844

#print axioms Mahjong.AnchorDAG.N19844.original_second_player_wins

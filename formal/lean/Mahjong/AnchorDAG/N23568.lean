...
import Mahjong.AnchorDAG.N19680
import Mahjong.AnchorDAG.N19682
import Mahjong.AnchorDAG.N19687
import Mahjong.AnchorDAG.N19693
import Mahjong.AnchorDAG.N19703
import Mahjong.AnchorDAG.N19718
import Mahjong.AnchorDAG.N19739
import Mahjong.AnchorDAG.N19774
import Mahjong.AnchorDAG.N19817

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23568

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 30 | 32 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 32 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 | 32 => true
  | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 33 => false
  | _ => false
...
def witness (t : Tile) : ExplicitWin.Witness :=
  ...
  | 32 => .standard (.triplet 4) (.triplet 5) (.triplet 7) (.sequence 0 0) 32
  | _ => .orphans 0

def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19817.state
  | 17 => AnchorDAG.N19774.state
  | 25 => AnchorDAG.N19739.state
  | 26 => AnchorDAG.N19718.state
  | 27 => AnchorDAG.N19703.state
  | 28 => AnchorDAG.N19693.state
  | 29 => AnchorDAG.N19687.state
  | 31 => AnchorDAG.N19682.state
  | 33 => AnchorDAG.N19680.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19739.proved
  · exact AnchorDAG.N19718.proved
  · exact AnchorDAG.N19703.proved
  · exact AnchorDAG.N19693.proved
  · exact AnchorDAG.N19687.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19682.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19680.proved
...
end Mahjong.AnchorDAG.N23568

#print axioms Mahjong.AnchorDAG.N23568.original_second_player_wins

...
import Mahjong.AnchorDAG.N19686
...
import Mahjong.AnchorDAG.N19822

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23573

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 29 | 30 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 30 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 27 | 28 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 29 | 30 => true
  | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19822.state
  | 17 => AnchorDAG.N19779.state
  | 25 => AnchorDAG.N19744.state
  | 26 => AnchorDAG.N19723.state
  | 27 => AnchorDAG.N19708.state
  | 28 => AnchorDAG.N19698.state
  | 31 => AnchorDAG.N19688.state
  | 32 => AnchorDAG.N19687.state
  | 33 => AnchorDAG.N19686.state
...
end Mahjong.AnchorDAG.N23573

#print axioms Mahjong.AnchorDAG.N23573.original_second_player_wins

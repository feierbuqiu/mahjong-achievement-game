...
import Mahjong.AnchorDAG.N19689
import Mahjong.AnchorDAG.N19691
import Mahjong.AnchorDAG.N19693
import Mahjong.AnchorDAG.N19696
import Mahjong.AnchorDAG.N19710
import Mahjong.AnchorDAG.N19725
import Mahjong.AnchorDAG.N19746
import Mahjong.AnchorDAG.N19781
import Mahjong.AnchorDAG.N19824

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23575

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 28 | 32 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 32 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 27 | 29 | 30 | 31 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 32 => true
  | 7 | 16 | 17 | 25 | 26 | 27 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19824.state
  | 17 => AnchorDAG.N19781.state
  | 25 => AnchorDAG.N19746.state
  | 26 => AnchorDAG.N19725.state
  | 27 => AnchorDAG.N19710.state
  | 29 => AnchorDAG.N19696.state
  | 30 => AnchorDAG.N19693.state
  | 31 => AnchorDAG.N19691.state
  | 33 => AnchorDAG.N19689.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19746.proved
  · exact AnchorDAG.N19725.proved
  · exact AnchorDAG.N19710.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19696.proved
  · exact AnchorDAG.N19693.proved
  · exact AnchorDAG.N19691.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19689.proved
...
end Mahjong.AnchorDAG.N23575

#print axioms Mahjong.AnchorDAG.N23575.original_second_player_wins

...
import Mahjong.AnchorDAG.N19692
import Mahjong.AnchorDAG.N19693
import Mahjong.AnchorDAG.N19694
import Mahjong.AnchorDAG.N19698
import Mahjong.AnchorDAG.N19712
import Mahjong.AnchorDAG.N19727
import Mahjong.AnchorDAG.N19748
import Mahjong.AnchorDAG.N19783
import Mahjong.AnchorDAG.N19826

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23577

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 28 | 30 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 27 | 29 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 28 | 30 => true
  | 7 | 16 | 17 | 25 | 26 | 27 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19826.state
  | 17 => AnchorDAG.N19783.state
  | 25 => AnchorDAG.N19748.state
  | 26 => AnchorDAG.N19727.state
  | 27 => AnchorDAG.N19712.state
  | 29 => AnchorDAG.N19698.state
  | 31 => AnchorDAG.N19694.state
  | 32 => AnchorDAG.N19693.state
  | 33 => AnchorDAG.N19692.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19748.proved
  · exact AnchorDAG.N19727.proved
  · exact AnchorDAG.N19712.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19698.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19694.proved
  · exact AnchorDAG.N19693.proved
  · exact AnchorDAG.N19692.proved
...
end Mahjong.AnchorDAG.N23577

#print axioms Mahjong.AnchorDAG.N23577.original_second_player_wins

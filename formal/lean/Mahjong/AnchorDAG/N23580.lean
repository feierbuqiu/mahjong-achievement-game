...
import Mahjong.AnchorDAG.N19699
import Mahjong.AnchorDAG.N19701
import Mahjong.AnchorDAG.N19703
import Mahjong.AnchorDAG.N19706
import Mahjong.AnchorDAG.N19710
import Mahjong.AnchorDAG.N19730
import Mahjong.AnchorDAG.N19751
import Mahjong.AnchorDAG.N19786
import Mahjong.AnchorDAG.N19829

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23580

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 32 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 32 => true
  | 7 | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19829.state
  | 17 => AnchorDAG.N19786.state
  | 25 => AnchorDAG.N19751.state
  | 26 => AnchorDAG.N19730.state
  | 28 => AnchorDAG.N19710.state
  | 29 => AnchorDAG.N19706.state
  | 30 => AnchorDAG.N19703.state
  | 31 => AnchorDAG.N19701.state
  | 33 => AnchorDAG.N19699.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19751.proved
  · exact AnchorDAG.N19730.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19710.proved
  · exact AnchorDAG.N19706.proved
  · exact AnchorDAG.N19703.proved
  · exact AnchorDAG.N19701.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19699.proved
...
end Mahjong.AnchorDAG.N23580

#print axioms Mahjong.AnchorDAG.N23580.original_second_player_wins

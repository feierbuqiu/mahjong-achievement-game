...
import Mahjong.AnchorDAG.N19702
import Mahjong.AnchorDAG.N19703
import Mahjong.AnchorDAG.N19704
import Mahjong.AnchorDAG.N19708
import Mahjong.AnchorDAG.N19712
import Mahjong.AnchorDAG.N19732
import Mahjong.AnchorDAG.N19753
import Mahjong.AnchorDAG.N19788
import Mahjong.AnchorDAG.N19831

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23582

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 30 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 30 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 28 | 29 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 30 => true
  | 7 | 16 | 17 | 25 | 26 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def witness (t : Tile) : ExplicitWin.Witness :=
  ...
  | 27 => .standard (.triplet 4) (.triplet 5) (.triplet 7) (.sequence 0 0) 27
  | 30 => .standard (.triplet 4) (.triplet 5) (.triplet 7) (.sequence 0 0) 30
  | _ => .orphans 0

def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19831.state
  | 17 => AnchorDAG.N19788.state
  | 25 => AnchorDAG.N19753.state
  | 26 => AnchorDAG.N19732.state
  | 28 => AnchorDAG.N19712.state
  | 29 => AnchorDAG.N19708.state
  | 31 => AnchorDAG.N19704.state
  | 32 => AnchorDAG.N19703.state
  | 33 => AnchorDAG.N19702.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19753.proved
  · exact AnchorDAG.N19732.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19712.proved
  · exact AnchorDAG.N19708.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19704.proved
  · exact AnchorDAG.N19703.proved
  · exact AnchorDAG.N19702.proved
...
end Mahjong.AnchorDAG.N23582

#print axioms Mahjong.AnchorDAG.N23582.original_second_player_wins

...
import Mahjong.AnchorDAG.N19709
import Mahjong.AnchorDAG.N19710
import Mahjong.AnchorDAG.N19711
import Mahjong.AnchorDAG.N19712
import Mahjong.AnchorDAG.N19713
import Mahjong.AnchorDAG.N19734
import Mahjong.AnchorDAG.N19755
import Mahjong.AnchorDAG.N19790
import Mahjong.AnchorDAG.N19833

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23584

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 | 28 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 => 0
  | 7 => 16
  | 16 | 17 | 25 | 26 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 | 28 => true
  | 7 | 16 | 17 | 25 | 26 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19833.state
  | 17 => AnchorDAG.N19790.state
  | 25 => AnchorDAG.N19755.state
  | 26 => AnchorDAG.N19734.state
  | 29 => AnchorDAG.N19713.state
  | 30 => AnchorDAG.N19712.state
  | 31 => AnchorDAG.N19711.state
  | 32 => AnchorDAG.N19710.state
  | 33 => AnchorDAG.N19709.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19755.proved
  · exact AnchorDAG.N19734.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19713.proved
  · exact AnchorDAG.N19712.proved
  · exact AnchorDAG.N19711.proved
  · exact AnchorDAG.N19710.proved
  · exact AnchorDAG.N19709.proved
...
end Mahjong.AnchorDAG.N23584

#print axioms Mahjong.AnchorDAG.N23584.original_second_player_wins

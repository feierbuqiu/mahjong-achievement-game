...
import Mahjong.AnchorDAG.N19714
import Mahjong.AnchorDAG.N19716
import Mahjong.AnchorDAG.N19718
import Mahjong.AnchorDAG.N19721
import Mahjong.AnchorDAG.N19725
import Mahjong.AnchorDAG.N19730
import Mahjong.AnchorDAG.N19757
import Mahjong.AnchorDAG.N19792
import Mahjong.AnchorDAG.N19835

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23586

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 32 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 32 => 0
  | 7 => 16
  | 16 | 17 | 25 | 27 | 28 | 29 | 30 | 31 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 32 => true
  | 7 | 16 | 17 | 25 | 27 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19835.state
  | 17 => AnchorDAG.N19792.state
  | 25 => AnchorDAG.N19757.state
  | 27 => AnchorDAG.N19730.state
  | 28 => AnchorDAG.N19725.state
  | 29 => AnchorDAG.N19721.state
  | 30 => AnchorDAG.N19718.state
  | 31 => AnchorDAG.N19716.state
  | 33 => AnchorDAG.N19714.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19757.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19730.proved
  · exact AnchorDAG.N19725.proved
  · exact AnchorDAG.N19721.proved
  · exact AnchorDAG.N19718.proved
  · exact AnchorDAG.N19716.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19714.proved
...
end Mahjong.AnchorDAG.N23586

#print axioms Mahjong.AnchorDAG.N23586.original_second_player_wins

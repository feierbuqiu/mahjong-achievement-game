...
import Mahjong.AnchorDAG.N19717
import Mahjong.AnchorDAG.N19718
import Mahjong.AnchorDAG.N19719
import Mahjong.AnchorDAG.N19723
import Mahjong.AnchorDAG.N19727
import Mahjong.AnchorDAG.N19732
import Mahjong.AnchorDAG.N19759
import Mahjong.AnchorDAG.N19794
import Mahjong.AnchorDAG.N19837

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23588

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 30 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 30 => 0
  | 7 => 16
  | 16 | 17 | 25 | 27 | 28 | 29 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 30 => true
  | 7 | 16 | 17 | 25 | 27 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19837.state
  | 17 => AnchorDAG.N19794.state
  | 25 => AnchorDAG.N19759.state
  | 27 => AnchorDAG.N19732.state
  | 28 => AnchorDAG.N19727.state
  | 29 => AnchorDAG.N19723.state
  | 31 => AnchorDAG.N19719.state
  | 32 => AnchorDAG.N19718.state
  | 33 => AnchorDAG.N19717.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19759.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19732.proved
  · exact AnchorDAG.N19727.proved
  · exact AnchorDAG.N19723.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19719.proved
  · exact AnchorDAG.N19718.proved
  · exact AnchorDAG.N19717.proved
...
end Mahjong.AnchorDAG.N23588

#print axioms Mahjong.AnchorDAG.N23588.original_second_player_wins

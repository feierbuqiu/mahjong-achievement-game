...
import Mahjong.AnchorDAG.N19720
import Mahjong.AnchorDAG.N19721
import Mahjong.AnchorDAG.N19722
...
namespace Mahjong.AnchorDAG.N23589

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 28 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 29 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 => 0
  | 7 => 16
  | 16 | 17 | 25 | 27 | 28 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 29 => true
  | 7 | 16 | 17 | 25 | 27 | 28 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19838.state
  | 17 => AnchorDAG.N19795.state
  | 25 => AnchorDAG.N19760.state
  | 27 => AnchorDAG.N19733.state
  | 28 => AnchorDAG.N19728.state
  | 30 => AnchorDAG.N19723.state
  | 31 => AnchorDAG.N19722.state
  | 32 => AnchorDAG.N19721.state
  | 33 => AnchorDAG.N19720.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N19722.proved
  · exact AnchorDAG.N19721.proved
  · exact AnchorDAG.N19720.proved
...
end Mahjong.AnchorDAG.N23589

#print axioms Mahjong.AnchorDAG.N23589.original_second_player_wins

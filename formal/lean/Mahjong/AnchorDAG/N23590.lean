...
import Mahjong.AnchorDAG.N19724
import Mahjong.AnchorDAG.N19725
import Mahjong.AnchorDAG.N19726
import Mahjong.AnchorDAG.N19727
import Mahjong.AnchorDAG.N19728
import Mahjong.AnchorDAG.N19734
import Mahjong.AnchorDAG.N19761
import Mahjong.AnchorDAG.N19796
import Mahjong.AnchorDAG.N19839

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23590

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 27 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 28 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 => 0
  | 7 => 16
  | 16 | 17 | 25 | 27 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 28 => true
  | 7 | 16 | 17 | 25 | 27 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19839.state
  | 17 => AnchorDAG.N19796.state
  | 25 => AnchorDAG.N19761.state
  | 27 => AnchorDAG.N19734.state
  | 29 => AnchorDAG.N19728.state
  | 30 => AnchorDAG.N19727.state
  | 31 => AnchorDAG.N19726.state
  | 32 => AnchorDAG.N19725.state
  | 33 => AnchorDAG.N19724.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19728.proved
  · exact AnchorDAG.N19727.proved
  · exact AnchorDAG.N19726.proved
  · exact AnchorDAG.N19725.proved
  · exact AnchorDAG.N19724.proved
...
end Mahjong.AnchorDAG.N23590

#print axioms Mahjong.AnchorDAG.N23590.original_second_player_wins

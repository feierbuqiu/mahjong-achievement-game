...
import Mahjong.AnchorDAG.N19729
import Mahjong.AnchorDAG.N19730
import Mahjong.AnchorDAG.N19731
import Mahjong.AnchorDAG.N19732
import Mahjong.AnchorDAG.N19733
import Mahjong.AnchorDAG.N19734
import Mahjong.AnchorDAG.N19762
import Mahjong.AnchorDAG.N19797
import Mahjong.AnchorDAG.N19840

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23591

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 26 | 27 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 => 0
  | 7 => 16
  | 16 | 17 | 25 | 28 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 26 | 27 => true
  | 7 | 16 | 17 | 25 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19840.state
  | 17 => AnchorDAG.N19797.state
  | 25 => AnchorDAG.N19762.state
  | 28 => AnchorDAG.N19734.state
  | 29 => AnchorDAG.N19733.state
  | 30 => AnchorDAG.N19732.state
  | 31 => AnchorDAG.N19731.state
  | 32 => AnchorDAG.N19730.state
  | 33 => AnchorDAG.N19729.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19762.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19734.proved
  · exact AnchorDAG.N19733.proved
  · exact AnchorDAG.N19732.proved
  · exact AnchorDAG.N19731.proved
  · exact AnchorDAG.N19730.proved
  · exact AnchorDAG.N19729.proved
...
end Mahjong.AnchorDAG.N23591

#print axioms Mahjong.AnchorDAG.N23591.original_second_player_wins

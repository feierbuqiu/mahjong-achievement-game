...
namespace Mahjong.AnchorDAG.N23594

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 31 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 31 => 0
  | 7 => 16
  | 16 | 17 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 31 => true
  | 7 | 16 | 17 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19843.state
  | 17 => AnchorDAG.N19800.state
  | 26 => AnchorDAG.N19758.state
  | 27 => AnchorDAG.N19752.state
  | 28 => AnchorDAG.N19747.state
  | 29 => AnchorDAG.N19743.state
  | 30 => AnchorDAG.N19740.state
  | 32 => AnchorDAG.N19737.state
  | 33 => AnchorDAG.N19736.state
...
end Mahjong.AnchorDAG.N23594

#print axioms Mahjong.AnchorDAG.N23594.original_second_player_wins

...
import Mahjong.AnchorDAG.N19741
import Mahjong.AnchorDAG.N19742
import Mahjong.AnchorDAG.N19743
...
import Mahjong.AnchorDAG.N19845

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23596

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 29 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 29 => 0
  | 7 => 16
  | 16 | 17 | 26 | 27 | 28 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 29 => true
  | 7 | 16 | 17 | 26 | 27 | 28 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19845.state
  | 17 => AnchorDAG.N19802.state
  | 26 => AnchorDAG.N19760.state
  | 27 => AnchorDAG.N19754.state
  | 28 => AnchorDAG.N19749.state
  | 30 => AnchorDAG.N19744.state
  | 31 => AnchorDAG.N19743.state
  | 32 => AnchorDAG.N19742.state
  | 33 => AnchorDAG.N19741.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N19743.proved
  · exact AnchorDAG.N19742.proved
  · exact AnchorDAG.N19741.proved
...
end Mahjong.AnchorDAG.N23596

#print axioms Mahjong.AnchorDAG.N23596.original_second_player_wins

...
import Mahjong.AnchorDAG.N19745
import Mahjong.AnchorDAG.N19746
import Mahjong.AnchorDAG.N19747
import Mahjong.AnchorDAG.N19748
import Mahjong.AnchorDAG.N19749
import Mahjong.AnchorDAG.N19755
import Mahjong.AnchorDAG.N19761
import Mahjong.AnchorDAG.N19803
import Mahjong.AnchorDAG.N19846

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23597

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 28 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 28 => 0
  | 7 => 16
  | 16 | 17 | 26 | 27 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 28 => true
  | 7 | 16 | 17 | 26 | 27 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19846.state
  | 17 => AnchorDAG.N19803.state
  | 26 => AnchorDAG.N19761.state
  | 27 => AnchorDAG.N19755.state
  | 29 => AnchorDAG.N19749.state
  | 30 => AnchorDAG.N19748.state
  | 31 => AnchorDAG.N19747.state
  | 32 => AnchorDAG.N19746.state
  | 33 => AnchorDAG.N19745.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19761.proved
  · exact AnchorDAG.N19755.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19749.proved
  · exact AnchorDAG.N19748.proved
  · exact AnchorDAG.N19747.proved
  · exact AnchorDAG.N19746.proved
  · exact AnchorDAG.N19745.proved
...
end Mahjong.AnchorDAG.N23597

#print axioms Mahjong.AnchorDAG.N23597.original_second_player_wins

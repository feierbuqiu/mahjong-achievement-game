...
import Mahjong.AnchorDAG.N19750
import Mahjong.AnchorDAG.N19751
import Mahjong.AnchorDAG.N19752
import Mahjong.AnchorDAG.N19753
import Mahjong.AnchorDAG.N19754
import Mahjong.AnchorDAG.N19755
import Mahjong.AnchorDAG.N19762
import Mahjong.AnchorDAG.N19804
import Mahjong.AnchorDAG.N19847

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23598

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 27 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 => 0
  | 7 => 16
  | 16 | 17 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 27 => true
  | 7 | 16 | 17 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19847.state
  | 17 => AnchorDAG.N19804.state
  | 26 => AnchorDAG.N19762.state
  | 28 => AnchorDAG.N19755.state
  | 29 => AnchorDAG.N19754.state
  | 30 => AnchorDAG.N19753.state
  | 31 => AnchorDAG.N19752.state
  | 32 => AnchorDAG.N19751.state
  | 33 => AnchorDAG.N19750.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N19754.proved
  · exact AnchorDAG.N19753.proved
  · exact AnchorDAG.N19752.proved
  · exact AnchorDAG.N19751.proved
  · exact AnchorDAG.N19750.proved
...
end Mahjong.AnchorDAG.N23598

#print axioms Mahjong.AnchorDAG.N23598.original_second_player_wins

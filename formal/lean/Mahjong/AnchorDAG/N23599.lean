...
import Mahjong.AnchorDAG.N19756
import Mahjong.AnchorDAG.N19757
import Mahjong.AnchorDAG.N19758
import Mahjong.AnchorDAG.N19759
import Mahjong.AnchorDAG.N19760
import Mahjong.AnchorDAG.N19761
import Mahjong.AnchorDAG.N19762
import Mahjong.AnchorDAG.N19805
import Mahjong.AnchorDAG.N19848

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23599

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 | 26 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 => 0
  | 7 => 16
  | 16 | 17 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 | 26 => true
  | 7 | 16 | 17 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19848.state
  | 17 => AnchorDAG.N19805.state
  | 27 => AnchorDAG.N19762.state
  | 28 => AnchorDAG.N19761.state
  | 29 => AnchorDAG.N19760.state
  | 30 => AnchorDAG.N19759.state
  | 31 => AnchorDAG.N19758.state
  | 32 => AnchorDAG.N19757.state
  | 33 => AnchorDAG.N19756.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N19760.proved
  · exact AnchorDAG.N19759.proved
  · exact AnchorDAG.N19758.proved
  · exact AnchorDAG.N19757.proved
  · exact AnchorDAG.N19756.proved
...
end Mahjong.AnchorDAG.N23599

#print axioms Mahjong.AnchorDAG.N23599.original_second_player_wins

...
import Mahjong.AnchorDAG.N19770
...
import Mahjong.AnchorDAG.N19851

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23602

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 17 | 18 | 20 | 22 | 23 | 32 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 32 => 0
  | 7 => 16
  | 16 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 17 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 32 => true
  | 7 | 16 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 16 => AnchorDAG.N19851.state
  | 25 => AnchorDAG.N19799.state
  | 26 => AnchorDAG.N19792.state
  | 27 => AnchorDAG.N19786.state
  | 28 => AnchorDAG.N19781.state
  | 29 => AnchorDAG.N19777.state
  | 30 => AnchorDAG.N19774.state
  | 31 => AnchorDAG.N19772.state
  | 33 => AnchorDAG.N19770.state
...
end Mahjong.AnchorDAG.N23602

#print axioms Mahjong.AnchorDAG.N23602.original_second_player_wins

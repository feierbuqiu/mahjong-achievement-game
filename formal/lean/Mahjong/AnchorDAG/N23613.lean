...
import Mahjong.AnchorDAG.N19821
import Mahjong.AnchorDAG.N19825
import Mahjong.AnchorDAG.N19830
import Mahjong.AnchorDAG.N19836
import Mahjong.AnchorDAG.N19843
import Mahjong.AnchorDAG.N19852

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23613

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 31 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 => 0
  | 7 => 17
  | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 => true
  | 7 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 17 => AnchorDAG.N19852.state
  | 25 => AnchorDAG.N19843.state
  | 26 => AnchorDAG.N19836.state
  | 27 => AnchorDAG.N19830.state
  | 28 => AnchorDAG.N19825.state
  | 29 => AnchorDAG.N19821.state
  | 30 => AnchorDAG.N19818.state
  | 32 => AnchorDAG.N19815.state
  | 33 => AnchorDAG.N19814.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N19843.proved
  · exact AnchorDAG.N19836.proved
  · exact AnchorDAG.N19830.proved
  · exact AnchorDAG.N19825.proved
  · exact AnchorDAG.N19821.proved
...
end Mahjong.AnchorDAG.N23613

#print axioms Mahjong.AnchorDAG.N23613.original_second_player_wins

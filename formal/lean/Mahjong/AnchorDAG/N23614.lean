...
namespace Mahjong.AnchorDAG.N23614

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 30 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 => 0
  | 7 => 17
  | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 => true
  | 7 | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 17 => AnchorDAG.N19853.state
  | 25 => AnchorDAG.N19844.state
  | 26 => AnchorDAG.N19837.state
  | 27 => AnchorDAG.N19831.state
  | 28 => AnchorDAG.N19826.state
  | 29 => AnchorDAG.N19822.state
  | 31 => AnchorDAG.N19818.state
  | 32 => AnchorDAG.N19817.state
  | 33 => AnchorDAG.N19816.state
...
end Mahjong.AnchorDAG.N23614

#print axioms Mahjong.AnchorDAG.N23614.original_second_player_wins

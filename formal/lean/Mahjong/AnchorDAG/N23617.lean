...
import Mahjong.AnchorDAG.N19830
import Mahjong.AnchorDAG.N19831
import Mahjong.AnchorDAG.N19832
import Mahjong.AnchorDAG.N19833
import Mahjong.AnchorDAG.N19840
import Mahjong.AnchorDAG.N19847
import Mahjong.AnchorDAG.N19856

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N23617

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 16 | 18 | 20 | 22 | 23 | 27 => 1
  | 4 | 5 => 4
  | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  match t.val with
  | 0 | 1 | 2 => 3
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 => 0
  | 7 => 17
  | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 7
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 16 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 => true
  | 7 | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 7 | 17 => AnchorDAG.N19856.state
  | 25 => AnchorDAG.N19847.state
  | 26 => AnchorDAG.N19840.state
  | 28 => AnchorDAG.N19833.state
  | 29 => AnchorDAG.N19832.state
  | 30 => AnchorDAG.N19831.state
  | 31 => AnchorDAG.N19830.state
  | 32 => AnchorDAG.N19829.state
  | 33 => AnchorDAG.N19828.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N19832.proved
  · exact AnchorDAG.N19831.proved
  · exact AnchorDAG.N19830.proved
...
end Mahjong.AnchorDAG.N23617

#print axioms Mahjong.AnchorDAG.N23617.original_second_player_wins

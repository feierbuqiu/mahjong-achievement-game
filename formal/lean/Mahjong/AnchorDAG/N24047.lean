...
import Mahjong.AnchorDAG.N23564
import Mahjong.AnchorDAG.N23566
...
import Mahjong.AnchorDAG.N23593
import Mahjong.AnchorDAG.N23602
import Mahjong.AnchorDAG.N23612
import Mahjong.AnchorDAG.N23698

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N24047

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 32 => 1
  | 4 => 4
  | 5 | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 10
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 32 => 0
  | 5 => 7
  | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 32 => true
  | 5 | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 7 => AnchorDAG.N23698.state
  | 16 => AnchorDAG.N23612.state
  | 17 => AnchorDAG.N23602.state
  | 25 => AnchorDAG.N23593.state
  | 26 => AnchorDAG.N23586.state
  | 27 => AnchorDAG.N23580.state
  | 28 => AnchorDAG.N23575.state
  | 29 => AnchorDAG.N23571.state
  | 30 => AnchorDAG.N23568.state
  | 31 => AnchorDAG.N23566.state
  | 33 => AnchorDAG.N23564.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23612.proved
  · exact AnchorDAG.N23602.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  ...
  · exact AnchorDAG.N23566.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23564.proved
...
end Mahjong.AnchorDAG.N24047

#print axioms Mahjong.AnchorDAG.N24047.original_second_player_wins

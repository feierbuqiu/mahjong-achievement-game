...
import Mahjong.AnchorDAG.N23613
import Mahjong.AnchorDAG.N23699

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N24048

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 31 => 1
  | 4 => 4
  | 5 | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 10
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 => 0
  | 5 => 7
  | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 31 => true
  | 5 | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 7 => AnchorDAG.N23699.state
  | 16 => AnchorDAG.N23613.state
  | 17 => AnchorDAG.N23603.state
  | 25 => AnchorDAG.N23594.state
  | 26 => AnchorDAG.N23587.state
  | 27 => AnchorDAG.N23581.state
  | 28 => AnchorDAG.N23576.state
  | 29 => AnchorDAG.N23572.state
  | 30 => AnchorDAG.N23569.state
  | 32 => AnchorDAG.N23566.state
  | 33 => AnchorDAG.N23565.state
...
end Mahjong.AnchorDAG.N24048

#print axioms Mahjong.AnchorDAG.N24048.original_second_player_wins

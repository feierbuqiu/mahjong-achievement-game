...
import Mahjong.AnchorDAG.N23567
import Mahjong.AnchorDAG.N23568
import Mahjong.AnchorDAG.N23569
...
import Mahjong.AnchorDAG.N23595
import Mahjong.AnchorDAG.N23604
import Mahjong.AnchorDAG.N23614
import Mahjong.AnchorDAG.N23700

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N24049

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 30 => 1
  | 4 => 4
  | 5 | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 10
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 => 0
  | 5 => 7
  | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 30 => true
  | 5 | 7 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 7 => AnchorDAG.N23700.state
  | 16 => AnchorDAG.N23614.state
  | 17 => AnchorDAG.N23604.state
  | 25 => AnchorDAG.N23595.state
  | 26 => AnchorDAG.N23588.state
  | 27 => AnchorDAG.N23582.state
  | 28 => AnchorDAG.N23577.state
  | 29 => AnchorDAG.N23573.state
  | 31 => AnchorDAG.N23569.state
  | 32 => AnchorDAG.N23568.state
  | 33 => AnchorDAG.N23567.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23614.proved
  · exact AnchorDAG.N23604.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23595.proved
  · exact AnchorDAG.N23588.proved
  · exact AnchorDAG.N23582.proved
  · exact AnchorDAG.N23577.proved
  · exact AnchorDAG.N23573.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23569.proved
  · exact AnchorDAG.N23568.proved
  · exact AnchorDAG.N23567.proved
...
end Mahjong.AnchorDAG.N24049

#print axioms Mahjong.AnchorDAG.N24049.original_second_player_wins

...
import Mahjong.AnchorDAG.N23579
import Mahjong.AnchorDAG.N23580
import Mahjong.AnchorDAG.N23581
import Mahjong.AnchorDAG.N23582
import Mahjong.AnchorDAG.N23583
import Mahjong.AnchorDAG.N23584
import Mahjong.AnchorDAG.N23591
import Mahjong.AnchorDAG.N23598
import Mahjong.AnchorDAG.N23607
import Mahjong.AnchorDAG.N23617
import Mahjong.AnchorDAG.N23703

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N24052

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 27 => 1
  | 4 => 4
  | 5 | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 10
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 => 0
  | 5 => 7
  | 7 | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 27 => true
  | 5 | 7 | 16 | 17 | 25 | 26 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 7 => AnchorDAG.N23703.state
  | 16 => AnchorDAG.N23617.state
  | 17 => AnchorDAG.N23607.state
  | 25 => AnchorDAG.N23598.state
  | 26 => AnchorDAG.N23591.state
  | 28 => AnchorDAG.N23584.state
  | 29 => AnchorDAG.N23583.state
  | 30 => AnchorDAG.N23582.state
  | 31 => AnchorDAG.N23581.state
  | 32 => AnchorDAG.N23580.state
  | 33 => AnchorDAG.N23579.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23617.proved
  · exact AnchorDAG.N23607.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23598.proved
  · exact AnchorDAG.N23591.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23584.proved
  · exact AnchorDAG.N23583.proved
  · exact AnchorDAG.N23582.proved
  · exact AnchorDAG.N23581.proved
  · exact AnchorDAG.N23580.proved
  · exact AnchorDAG.N23579.proved
...
end Mahjong.AnchorDAG.N24052

#print axioms Mahjong.AnchorDAG.N24052.original_second_player_wins

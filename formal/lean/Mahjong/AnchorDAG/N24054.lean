...
import Mahjong.AnchorDAG.N23592
import Mahjong.AnchorDAG.N23593
import Mahjong.AnchorDAG.N23594
...
import Mahjong.AnchorDAG.N23609
import Mahjong.AnchorDAG.N23619
import Mahjong.AnchorDAG.N23705

set_option maxRecDepth 8192
set_option maxHeartbeats 10000000

namespace Mahjong.AnchorDAG.N24054

open ResponseCertificate

def state (t : Tile) : Nat :=
  match t.val with
  | 0 | 3 | 6 | 10 | 12 | 15 | 16 | 17 | 19 | 21 | 24 | 26 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => 0
  | 1 | 2 | 8 | 9 | 11 | 13 | 14 | 18 | 20 | 22 | 23 | 25 => 1
  | 4 => 4
  | 5 | 7 => 3
  | _ => 0
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 10
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 => 0
  | 5 => 7
  | 7 | 16 | 17 | 26 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 | 25 => true
  | 5 | 7 | 16 | 17 | 26 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 7 => AnchorDAG.N23705.state
  | 16 => AnchorDAG.N23619.state
  | 17 => AnchorDAG.N23609.state
  | 26 => AnchorDAG.N23599.state
  | 27 => AnchorDAG.N23598.state
  | 28 => AnchorDAG.N23597.state
  | 29 => AnchorDAG.N23596.state
  | 30 => AnchorDAG.N23595.state
  | 31 => AnchorDAG.N23594.state
  | 32 => AnchorDAG.N23593.state
  | 33 => AnchorDAG.N23592.state
...
theorem continuation_proved (t : Tile) : ProvedP (continuation t) := by
  ...
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N23619.proved
  · exact AnchorDAG.N23609.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  · exact AnchorDAG.N00000.proved
  ...
  · exact AnchorDAG.N23594.proved
  · exact AnchorDAG.N23593.proved
  · exact AnchorDAG.N23592.proved
...
end Mahjong.AnchorDAG.N24054

#print axioms Mahjong.AnchorDAG.N24054.original_second_player_wins

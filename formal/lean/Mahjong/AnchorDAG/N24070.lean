...
namespace Mahjong.AnchorDAG.N24070
...
def reply (t : Tile) : Tile :=
  ...
  | 0 | 1 => 3
  | 2 => 6
  | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 => 0
  | 5 => 16
  | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => 5
  | _ => 0

def winning (t : Tile) : Bool :=
  match t.val with
  | 0 | 1 | 2 | 3 | 6 | 8 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 18 | 19 | 20 | 21 | 22 | 23 | 24 => true
  | 5 | 16 | 17 | 25 | 26 | 27 | 28 | 29 | 30 | 31 | 32 | 33 => false
  | _ => false
...
def witness (t : Tile) : ExplicitWin.Witness :=
  ...
  | 2 => .standard (.triplet 4) (.triplet 5) (.triplet 7) (.sequence 0 6) 2
  | 6 => .standard (.triplet 5) (.triplet 7) (.sequence 0 0) (.sequence 0 6) 4
...
def continuation (t : Tile) : State :=
  match t.val with
  | 5 | 16 => AnchorDAG.N23707.state
  | 17 => AnchorDAG.N23706.state
  | 25 => AnchorDAG.N23705.state
  | 26 => AnchorDAG.N23704.state
  | 27 => AnchorDAG.N23703.state
  | 28 => AnchorDAG.N23702.state
  | 29 => AnchorDAG.N23701.state
  | 30 => AnchorDAG.N23700.state
  | 31 => AnchorDAG.N23699.state
  | 32 => AnchorDAG.N23698.state
  | 33 => AnchorDAG.N23697.state
...
end Mahjong.AnchorDAG.N24070

#print axioms Mahjong.AnchorDAG.N24070.original_second_player_wins
